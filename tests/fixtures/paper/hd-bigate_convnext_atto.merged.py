...
custom_imports = dict(
    ...
    imports=[
        ...
        'mmseg.models.backbones.dual_convnext_serial',
        ...
        'mmseg.models.backbones.dual_convnext_bigate',
    ])
...
model = dict(
    ...
    backbone=dict(
        ...
        fusion_reduction=4,
        type='DualConvNeXtAttoPlusBiGate'),
    data_preprocessor=dict(
        bgr_to_rgb=True,
        mean=[
            123.675,
...
work_dir = 'work_dirs_v12+_512_gate_ablation_ext/37/chamnet_dual_plus_bigate_convnext_atto'
