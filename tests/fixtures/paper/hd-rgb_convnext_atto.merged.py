...
custom_imports = dict(
    ...
    imports=[
        ...
        'mmseg.models.backbones.dual_convnext_rgb',
...
model = dict(
    ...
    backbone=dict(
        ...
        fusion_reduction=4,
        type='DualConvNeXtAttoPlusSerialRGB'),
    data_preprocessor=dict(
        bgr_to_rgb=True,
        mean=[
            123.675,
...
work_dir = 'work_dirs_v12+_512_controls_rgb_ext/37/chamnet_dual_plus_rgb_convnext_atto'
