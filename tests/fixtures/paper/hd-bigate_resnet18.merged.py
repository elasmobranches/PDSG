...
custom_imports = dict(
    ...
    imports=[
        ...
        'mmseg.models.backbones.dual_resnet_late',
        ...
        'mmseg.models.backbones.dual_resnet_bigate',
    ])
...
optim_wrapper = dict(
    ...
    paramwise_cfg=dict(
        custom_keys=dict(head=dict(lr_mult=5.0), norm=dict(decay_mult=0.0))),
    type='OptimWrapper')
...
work_dir = 'work_dirs_v12+_512_gate_ablation/37/chamnet_dual_plus_bigate_resnet18'
